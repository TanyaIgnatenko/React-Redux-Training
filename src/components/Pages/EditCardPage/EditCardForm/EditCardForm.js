...
export default function EditCardForm(props) {
    return (
        <div className='edit-card-form__container'>
            ...
            <div className='edit-card-form__buttons-container'>
                <Link to='/'><input type='button' className='edit-card-form__save-button' value='Save'/></Link>
                <Link to='/'><input type='button' className='edit-card-form__delete-button' value='Delete'/></Link>
            </div>
        </div>
    );
}
