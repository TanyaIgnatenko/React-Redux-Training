...
export default function NewCardButton(props) {
    ...
    return (
        <div className='new-card-button__container' onClick={props.onClick}>
            <svg x='0px' y='0px' viewBox='0 0 432 432' cursor='pointer'><g>
		...
		c3.613,3.615,5.421,7.898,5.421,12.847V237.539z'/></g>
            </svg>
        </div>
    );
}
