...
const RESET_FETCH_POSTS_STATUS = '@@auth/RESET_FETCH_POSTS_STATUS';
const RESET_ADD_POST_STATUS = '@@auth/RESET_ADD_POST_STATUS';
const RESET_EDIT_POST_STATUS = '@@auth/RESET_EDIT_POST_STATUS';
const RESET_REMOVE_POST_STATUS = '@@auth/RESET_REMOVE_POST_STATUS';
const RESET_TOGGLE_LIKE_STATUS = '@@auth/RESET_TOGGLE_LIKE_STATUS';
